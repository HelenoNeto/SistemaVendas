...
public class ConnectionFactory {
    ...
    static {
        try {
            ...
            /*
             * Como log usaremos o stacktrace das excessões, mas recomendo que
             * para um projeto real você utilize algum mecanismo de log melhor,
             * como o Log4J por exemplo.
             */
            exc.printStackTrace();
    ...
    public static Connection getConnection() throws SQLException {
        ...
        return ConnectionFactory.getConnection(
                "jdbc:mysql://" + Dir.KEY_SERVHOST + "/" + Dir.KEY_DATABASE,
                Dir.KEY_USUARIO,
                Dir.KEY_SENHA);
