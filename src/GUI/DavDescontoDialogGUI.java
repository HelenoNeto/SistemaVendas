 ...
 */
public class DavDescontoDialogGUI extends javax.swing.JDialog {
    ...
    public DavDescontoDialogGUI(java.awt.Frame parent, boolean modal, BigDecimal valorTotalVenda) {
        super(parent, modal);
        initComponents();
        jRB_desconto_taxa.setSelected(true);
        this.valor = valorTotalVenda;
    ...
    private void initComponents() {
        ...
        setTitle("Desconto DAV");
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Desconto"));
        jPanel1.setFocusable(false);

        buttonGroup1.add(jRB_desconto_valor);
        jRB_desconto_valor.setText("Desconto Valor(R$)");
        jRB_desconto_valor.setFocusable(false);

        buttonGroup1.add(jRB_desconto_taxa);
        jRB_desconto_taxa.setText("Desconto Taxa(%)");
    ...
    private void jB_okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_okActionPerformed
        desconto = new BigDecimal(jTF_desconto.getText());
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DavDescontoDialogGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                DavDescontoDialogGUI dialog = new DavDescontoDialogGUI(new javax.swing.JFrame(), true, BigDecimal.ZERO);
    ...
    public String retornaTipoDesconto() {
    ...
    public String retornaValorDesconto() {
        return String.valueOf(desconto.setScale(2, RoundingMode.HALF_DOWN));
    }
}
